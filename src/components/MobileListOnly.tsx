            ...
            {sortedReports.map((report) => (
              ...
              >
                ...
                <div className="text-[11px] text-slate-700 space-y-2 leading-relaxed">
                  ...
                  {report.notes && (
                    <div className="p-2 bg-slate-50/90 rounded border-l-2 border-slate-400 text-[10.5px] italic text-slate-800 font-medium whitespace-pre-wrap break-words max-h-[100px] overflow-y-auto thin-scrollbar">
